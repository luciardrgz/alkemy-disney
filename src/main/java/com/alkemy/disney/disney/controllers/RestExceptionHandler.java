...
@ControllerAdvice // Class in charge of handling all exceptions that the API might throw
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        // Once all the errors are obtained for invalid args, apiError is created
